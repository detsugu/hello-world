...
EQUIPMENT = [
    ...
    (16, "ground_medium", "a close-up macro photo of a heaped mound of coarsely ground coffee from medium-roast beans on a clean white countertop, warm milk-chocolate tan-brown; a coarse French-press grind made of distinct individual loose grains, each grain a separate dry granule about the size of a coarse sea salt or kosher salt crystal, all grains roughly the same uniform size; absolutely no fine powder, no dust, not cocoa powder, no powdery clumps or balls, no long thin chaff slivers"),
    (17, "ground_light",  "a close-up macro photo of a heaped mound of coarsely ground coffee from light-roast beans on a clean white countertop, pale cinnamon light tan; a coarse French-press grind made of distinct individual loose grains, each grain a separate dry granule about the size of a coarse sea salt or kosher salt crystal, all grains roughly the same uniform size; absolutely no fine powder, no dust, not cocoa powder, no powdery clumps or balls, no long thin chaff slivers"),
]
