...
EQUIPMENT = [
    ...
    (16, "ground_medium", "a generous heaped mound of ground coffee from medium-roast beans, unevenly crushed into irregular non-uniform particles of mixed sizes (larger angular fragments together with finer bits, clearly not a uniform powder); a mottled two-tone look where the darker inner bean fragments and the lighter outer skin and husk flecks show slightly different shades, overall a warm milk-chocolate tan-brown, piled into a small mound on a clean white countertop"),
    (17, "ground_light",  "a generous heaped mound of ground coffee from light-roast beans, coarsely and unevenly crushed into irregular non-uniform particles of mixed sizes (chunky angular bean fragments mixed with finer grit, clearly not a uniform powder); a mottled speckled look with pale skin and husk flecks scattered among the bean fragments in slightly different shades, overall a pale cinnamon light tan, piled into a small mound on a clean white countertop"),
]
